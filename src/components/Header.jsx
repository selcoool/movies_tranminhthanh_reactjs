      ...
      <div className="mt-6 flow-root">
        <div className="-my-6 divide-y divide-gray-500/10">
          ...
          <Link to={`/theater`} className={`-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 ${pathname==='/theater' ? 'text-white' :'text-gray-900'}  hover:bg-gray-50`}>Cụm Rạp</Link>
            ...
            <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50" onClick={()=>setOpenMenuNavbar(false)}>Ứng Dụng</a>
          </div>
          <div className="py-6">
